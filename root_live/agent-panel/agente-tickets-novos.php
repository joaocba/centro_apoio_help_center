...
$latest = [];
$sql = "SELECT * FROM tickets WHERE status=0 ORDER BY date DESC";
                ...
                <div class="container-fluid px-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <p>Aqui pode verificar todos os novos tickets</p>
                    ...
                    <h1 class="mt-2 mb-1">Novos Tickets</h1>
                    <div class="text-muted">
                        Lista de tickets registados com estado Novo
                    </div>
