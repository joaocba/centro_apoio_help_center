...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE users SET email='$email_novo', nome='$nome_novo', apelido='$apelido_novo', telefone='$telefone_novo', morada='$morada_novo', cod_postal='$cod_postal_novo', cidade='$cidade_novo', nome_empresa='$nome_empresa_novo', local_empresa='$local_empresa_novo', dep_empresa='$dep_empresa_novo' WHERE role=1 AND id=" . $_GET['id'];
    ...
    if ($inset) {
        ...
        header('Location: ../admin-panel/gerir-agentes.php?status=userupdated');
    } else {
            ...
            <main>
                <div class="container-fluid px-5">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Editar Perfil Agente <?php echo $nome . ' ' . $apelido; ?></li>
                    </ol>
                                ...
                                <div class="profile-input-field">
                                    ...
                                    <form method="post" onSubmit="return validate();">
                                        ...
                                        <div class="">
                                            ...
                                            <a href="../admin-panel/agente.php?id=<?php echo $user_id; ?>" target="_self" rel="noopener noreferrer" class="btn btn-dark">Voltar</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
