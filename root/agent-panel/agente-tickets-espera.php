...
$latest = [];
$sql = "SELECT * FROM tickets WHERE status=1 ORDER BY date DESC";
            ...
            <main>
                <div class="container-fluid px-5">
                    ...
                    <ol class="breadcrumb mb-4">
                        ...
                        <li class="breadcrumb-item active">Tickets em Espera</li>
                    </ol>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12">
                            <div class="card mb-4">
                                <div class="card-body">
                                    <p>Aqui pode verificar todos os tickets que estão em resolução</p>
                    ...
                    <h1 class="mt-2 mb-1">Tickets em Espera</h1>
                    <div class="text-muted">
                        Lista de tickets registados que estão em resolução
                    </div>
