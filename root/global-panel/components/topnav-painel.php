...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark shadow">
    <!-- Logo -->
    <a class="navbar-brand ps-3" href="<?= $_SERVER['PHP_SELF'] ?>"><img src="./assets/img/logos/logof_white.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top"> Centro de Apoio</a>
    <!-- Botão Sidebar -->
